    ...
    <>
      <style jsx>{`
        @media screen and (width: 1024px) and (height: 600px) {
          .instructor-container { transform: translateY(-20px); }
          .instructor-image { width: 120px !important; height: 150px !important; }
          .quote-text { font-size: 14px !important; line-height: 1.4 !important; }
        }
        @media screen and (width: 1280px) and (height: 800px) {
          .instructor-container { transform: translateY(-20px); }
          .instructor-image { width: 130px !important; height: 160px !important; }
          .quote-text { font-size: 16px !important; line-height: 1.4 !important; }
        }
        @media screen and (min-width: 820px) and (max-width: 850px) and (min-height: 1180px) and (max-height: 1210px),
          ...
          .video-container { height: 30vh !important; }
          .instructor-container { transform: translateY(-80px) !important; margin-top: -40px !important; }
          .instructor-image { width: 120px !important; height: 150px !important; }
          .quote-text { font-size: 16px !important; line-height: 1.4 !important; }
          .quote-container { transform: translateY(-60px) !important; margin-top: -30px !important; }
          .main-content-section { padding-top: 10px !important; margin-top: -20px !important; }
        }
        @media screen and (min-width: 1010px) and (max-width: 1040px) and (min-height: 1350px) and (max-height: 1380px),
          ...
          .video-container { height: 32vh !important; }
          .instructor-container { transform: translateY(-80px) !important; margin-top: -40px !important; }
          .instructor-image { width: 130px !important; height: 160px !important; }
          .quote-text { font-size: 18px !important; line-height: 1.4 !important; }
          .quote-container { transform: translateY(-60px) !important; margin-top: -30px !important; }
          .main-content-section { padding-top: 10px !important; margin-top: -20px !important; }
        }
        ...
        <div className="flex-1 bg-gradient-to-br from-[#1a0033]/90 via-[#2d1b69]/80 via-[#4c1d95]/85 via-[#6b21a8]/80 to-[#7c3aed]/90 backdrop-blur-sm flex flex-col lg:flex-row main-content-section relative z-10">
          ...
          <div className="sm:hidden w-full min-h-screen flex flex-col items-center justify-center relative">
            <div className="flex flex-col items-center justify-center px-6 py-8 space-y-8 max-w-sm mx-auto">
              ...
              {/* Explore Button — tap to expand Online / Offline */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div
                  className={`cursor-pointer flex items-center justify-center w-[220px] h-[48px]
                    text-purple-600 font-bold text-base rounded-lg transition-all duration-300
                    border border-purple-300 shadow-[0_0_15px_rgba(168,85,247,0.4)]
                    backdrop-blur-sm active:scale-95 relative overflow-hidden group
                    ${mobileExpanded
                      ? "bg-gradient-to-r from-purple-600 via-purple-500 to-violet-600 text-white shadow-[0_12px_40px_-8px_rgba(147,51,234,1)]"
                      : "bg-white"
                    }`}
                    ...
                    {mobileExpanded ? (
                      <div className="flex justify-center items-center space-x-6 w-full">
                        <button
                          ...
                          className="font-bold active:opacity-70 transition-opacity"
                        >
                          Online
                        </button>
                        <div className="w-px h-4 bg-current opacity-40"></div>
