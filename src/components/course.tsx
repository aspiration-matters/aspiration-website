...
//   return (
//     <section id="courses" className="min-h-screen bg-gradient-to-br from-[#e0c3fc]/80 via-[#8ec5fc]/70 to-[#ffffff]/80 backdrop-blur-2xl backdrop-saturate-200 flex flex-col">
//       {/* Desktop Video Background */}
//       <div className="hidden sm:block relative overflow-hidden mt-20" style={{ height: "45vh" }}>
...
//               transition={{ duration: 0.8 }}
//             >
//               <div className="relative w-36 h-44 mb-4">
...
//               transition={{ duration: 0.8 }}
//             >
//               <div className="relative w-44 h-56 md:w-56 md:h-72 mb-6">
//                 <Image src="/instructor.png" alt="Neelima Kumari" fill className="object-contain" priority />
//               </div>
//               <Link href="" className="group transition-all duration-300">
...
//                 <p className="text-xl md:text-2xl lg:text-3xl text-gray-800 leading-relaxed whitespace-pre-line text-center lg:text-left font-medium">
//                   &quot;{typedText}&quot;
//                 </p>
//               </blockquote>
//             </motion.div>
...
//     >
//       {/* Desktop Video Background */}
//       <div className="hidden sm:block relative overflow-hidden mt-20 h-[45vh] md:h-[35vh] lg:h-[45vh] xl:h-[45vh]">
//         <div className="absolute inset-0">
//           <video ref={videoRef} className="w-full h-full bg-black object-cover" loop muted playsInline>
//             <source src="/video.mp4" type="video/mp4" />
//             Your browser does not support the video tag.
...
//               transition={{ duration: 0.8, delay: 0.2 }}
//             >
//               <p className="text-sm text-gray-800 leading-relaxed mb-6 whitespace-pre-line text-center font-medium">
//                 &quot;{quoteText}&quot;
//               </p>
//             </motion.blockquote>
...
//               transition={{ duration: 0.8 }}
//             >
//               <div className="relative w-40 h-52 md:w-48 md:h-64 mb-6">
//                 <Image src="/instructor.png" alt="Neelima Kumari" fill className="object-contain" priority />
//               </div>
//               <Link href="" className="group transition-all duration-300">
//                 <h3 className="text-xl md:text-2xl font-bold text-center mb-2 group-hover:text-purple-700">
...
//             >
//               <blockquote className="relative">
//                 <p className="text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed whitespace-pre-line text-center lg:text-left font-medium">
//                   &quot;{typedText}&quot;
//                 </p>
//               </blockquote>
//             </motion.div>
...
//   return (
//     <>
//       {/* Nest Hub and Nest Hub Max specific styles */}
//       <style jsx>{`
//         /* Nest Hub (1024x600) */
