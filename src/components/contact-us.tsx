...
//   [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:max-w-lg"
//             >
//               <BorderBeam duration={8} size={100} />
//               <CardHeader
//                 className="pb-4 
...
//               <CardContent
//                 className="px-8 
//     [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:px-6"
//               >
//                 <Tabs defaultValue="email" className="w-full">
//                   <TabsList className="grid w-full grid-cols-2 bg-transparent mb-8">
//                     <TabsTrigger
