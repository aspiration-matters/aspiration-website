...
//       <section
//         id="contact"
//         className="flex-grow flex flex-col justify-between bg-gradient-to-br from-[#e0c3fc]/80 via-[#8ec5fc]/70 to-[#ffffff]/80 backdrop-blur-2xl backdrop-saturate-200 p-4 md:p-8"
//       >
//         <div
//           className="w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-8 flex-grow flex items-center pt-12 md:pt-16 
...
//               >
//                 <div
//                   className="flex items-start gap-3 group p-4 rounded-lg transition-all duration-300 hover:bg-white/50 hover:shadow-lg cursor-pointer 
//                     [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:p-3
//                     max-sm:p-3"
//                 >
//                   <FaMapMarkerAlt
//                     className="w-5 h-5 text-purple-600 mt-1 flex-shrink-0 group-hover:scale-110 transition-transform 
...
//                   <div>
//                     <p
//                       className="font-medium text-lg group-hover:text-purple-600 transition-colors 
...
//                     </p>
//                     <p
//                       className="text-muted-foreground group-hover:text-gray-700 transition-colors 
...
//                 <div
//                   className="flex items-center gap-3 group p-4 rounded-lg transition-all duration-300 hover:bg-white/50 hover:shadow-lg cursor-pointer 
//                     [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:p-3
//                     max-sm:p-3"
//                 >
//                   <FaPhone
//                     className="w-5 h-5 -scale-x-100 text-purple-600 flex-shrink-0 transition-transform group-hover:scale-110 group-hover:-scale-x-100 
//                       [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:w-4 
//                       [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:h-4
//                       max-sm:w-4 max-sm:h-4"
//                   />
...
//                 >
//                   <FaEnvelope
//                     className="w-5 h-5 text-purple-600 flex-shrink-0 group-hover:scale-110 transition-transform 
//                       [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:w-4 
//                       [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:h-4
//                       max-sm:w-4 max-sm:h-4"
//                   />
...
//             <Card
//               className="backdrop-blur-sm bg-white/70 border-purple-200 w-full max-w-xl shadow-xl rounded-xl overflow-hidden 
...
//                               [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:min-h-[120px] 
//                               [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:text-base 
//                               [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:pl-10
//                               max-sm:min-h-[120px] max-sm:text-base max-sm:pl-10"
...
//       {/* Enhanced Premium Footer Section - Mobile Optimized */}
...
//               <div>
//                 <h3
//                   className={`${workSans.className} text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-200 via-white to-purple-200 mb-2 max-sm:text-xl`}
//                 >
//                   Aspiration Matters
//                 </h3>
...
//               >
//                 <div
//                   className="flex items-start gap-3 group p-4 rounded-lg transition-all duration-300 hover:bg-white/10 hover:shadow-lg cursor-pointer 
//                     [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:p-3
//                     max-sm:p-3"
//                 >
//                   <FaMapMarkerAlt
...
//                 <div
//                   className="flex items-center gap-3 group p-4 rounded-lg transition-all duration-300 hover:bg-white/10 hover:shadow-lg cursor-pointer 
//                     [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:p-3
//                     max-sm:p-3"
//                 >
//                   <FaPhone
...
//       <footer className="w-full bg-gradient-to-r from-[#0f001a] via-[#1a0033] to-[#0f001a] text-white shadow-lg border-t border-purple-500/20">
//         <div
//           className="max-w-7xl mx-auto px-4 py-8 
//             [@media(min-width:1024px)_and_(max-width:1280px)_and_(max-height:800px)]:py-6
//             max-sm:px-3 max-sm:py-6"
