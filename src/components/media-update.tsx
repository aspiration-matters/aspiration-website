...
const mediaContent = [
...

    {
        ...
        content:
            "Successfully conducted a Managerial Soft Skills Development Program at Laurus Labs, Visakhapatnam, focusing on coaching, mentoring, strategic thinking, decision-making, and delegation excellence. This experiential intervention was designed to strengthen managerial capability, enhance leadership effectiveness, and empower managers to lead with clarity, confidence, and accountability.",
        highlights: [
    ...
    },
    {
        ...
        content:
            "Leadership isn’t built in boardrooms alone — it’s revealed outside comfort zones. Experience the power of Outbound Training (OBT) with Neelima Kumari, Visakhapatnam’s only Female OBT Trainer for Senior Leadership Teams. In today’s fast-changing corporate world, senior leaders don’t just need skills — they need alignment, resilience, and trust. This is not adventure. This is strategic leadership development — experienced, not taught.",
        highlights: [
            "Sharper decision-making in real-time challenges",
            "Natural collaboration and trust-building",
            "Authentic leadership presence through experiential learning",
            "Designed for Senior Leadership, CXOs & HR Teams",
        ],
        youtubeUrl: "https://www.youtube.com/watch?v=PBnvnsNtJGE",
        tags: [
            "Senior Leadership OBT",
            "Female OBT Trainer Vizag",
            "Corporate Offsite Training",
            "CXO Leadership Programs",
        ],
        location: "Visakhapatnam (Vizag)",
    },
    {
    ...
    },
    {
        ...
        content:
            "Neelima Kumari, motivational speaker and leadership facilitator, recently delivered a high-impact motivational talk for Canara Bank, centered on her signature framework “Audit Within”. The session invited individuals to pause, reflect, and take ownership before seeking change externally. In high-pressure banking environments, Audit Within reinforces that lasting excellence begins from the inside out.",
        highlights: [
            "Auditing mindset, attitudes, and responses in high-pressure roles",
            "Building emotional resilience and inner stability",
            "Strengthening self-belief, accountability, and conscious leadership",
            "Aligning personal purpose with organizational responsibility",
        ],
        tags: [
            "Motivational Speaker India",
            "Keynote Speaking",
            "Audit Within Framework",
            "Banking Leadership Programs",
...
const images = [
    ...
    "/mediaimage15.jpg",
    "/mediaimage14.jpg",
    "/d1f623d2-2609-477e-86af-8c6ea4b6ade7.jpeg",
    "/88c190cf-f7c3-4aab-bad0-d0ddf2c1c7e1.jpeg"
]
                                    ...
                                    >
                                        ...
                                        <div className="space-y-1 text-center lg:text-left">
                                            ...
                                            <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4 justify-center lg:justify-start">
                                                ...
                                                {mediaContent[currentMedia].youtubeUrl && (
                                                    <button
                                                        onClick={() => handleYouTube(mediaContent[currentMedia].youtubeUrl!)}
                                                        className="inline-flex items-center gap-2 text-xs sm:text-sm font-semibold text-white bg-green-600 hover:bg-green-700 transition-colors px-3 py-1 rounded-full w-fit mx-auto lg:mx-0 shadow-lg shadow-red-900/20 active:scale-95 transform transition-transform"
                                                    >
