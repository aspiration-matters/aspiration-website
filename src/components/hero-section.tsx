...
//                     animate={{ opacity: 1, y: 0 }}
//                     transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }}
//                     className="mt-20 lg:mt-24 w-full flex flex-col lg:flex-row items-center lg:items-end justify-center lg:justify-between gap-8 lg:gap-6"
//                 >
//                     {/* Get Started */}
//                     <div className="scale-[1.4] origin-center lg:origin-left">
//                         <InteractiveHoverButton
//                             onClick={() => {
//                                 const contactSection = document.getElementById("contact")
//                                 if (contactSection) {
