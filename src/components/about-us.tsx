...
//       id="about"
//       ref={ref}
//       className="min-h-screen flex flex-col items-center justify-center bg-[#ea99ff] overflow-hidden"
//     >
...
const About = () => {
  ...
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="relative inline-block pb-3">
              <h2
                className={`${workSans.className} text-3xl font-medium  text-[#5d2878]`}
              >
                About us
              </h2>
              <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#5d2878]" />
            </div>

            <div className="prose prose-sm sm:prose-base lg:prose-lg font-playfair max-w-none">
              <p className="text-[#540464] leading-relaxed text-base sm:text-lg md:text-xl text-justify">
                {previewText}
              </p>
            </div>
            <div className="pt-2 sm:pt-4">
    ...
    bg-[#c418c2] hover:bg-[#a212a8] 
    text-white font-bold text-sm sm:text-base rounded-lg transition-all duration-300
    shadow-[0_4px_20px_-4px_#c418c2] hover:shadow-[0_8px_25px_-5px_#a212a8]"
                >
                  <span className="flex items-center gap-x-1 sm:gap-x-2">
                    Read More <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5" />
                  </span>
