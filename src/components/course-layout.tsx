...
//                 href="/course-platform"
//                 className={cn(
//                   "hidden md:flex items-center gap-2 transition-colors relative",
//                   isActive("/course-platform") ? "text-primary font-medium" : "text-primary/70 hover:text-primary/90",
//                 )}
//               >
//                 <Home className="h-6 w-6 stroke-[1.5px]" />
//                 {isActive("/course-platform") && (
//                   <span className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-1.5 h-1.5 bg-primary rounded-full" />
//                 )}
//               </Link>
...
//                 className={cn(
//                   "hidden md:flex items-center gap-2 transition-colors relative",
//                   isActive("/my-learning") ? "text-primary font-medium" : "text-primary/70 hover:text-primary/90",
//                 )}
//               >
...
//                   isActive("/cart") ? "text-primary font-medium" : "text-primary/70 hover:text-primary/90",
//                 )}
//               >
//                 <ShoppingCart className="h-6 w-6 stroke-[1.5px]" />
//                 {cartCount > 0 && (
