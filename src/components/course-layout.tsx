...
export function CourseLayout({
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="border-b sticky top-0 bg-background/95 backdrop-blur-md z-50 shadow-sm relative">
      ...
      {/* Main Content */}
      <main className="flex-1 container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8 relative z-10">
        {children}
      </main>

      {/* Footer */}
      <footer className="bg-background/90 backdrop-blur-md border-t py-4 sm:py-6 relative z-10">
