...
export function PremiumVideoPlayer({ src, poster, title, onComplete, className }: VideoPlayerProps) {
  ...
  const skip = (seconds: number) => {
    ...
    // Show a visual indicator for skipping
  ...
  return (
    ...
    >
      ...
      {/* Premium badge */}
      {isPremium && (
        <div className="absolute top-4 right-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1 z-10 shadow-md">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Slider
                ...
                className="w-20 hidden sm:block [&>span:first-child]:h-1 [&>span:first-child]:bg-white/30 [&_[role=slider]]:bg-white [&_[role=slider]]:w-3 [&_[role=slider]]:h-3 [&>span:first-child_span]:bg-white"
              />
            </div>
              ...
              <DialogContent>
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-2 items-center gap-4">
                    <div className="font-medium">Space or K</div>
                    <div>Play/Pause</div>
                  </div>
                  <div className="grid grid-cols-2 items-center gap-4">
                  ...
                  <div className="grid grid-cols-2 items-center gap-4">
                    ...
                    <div>Rewind/Forward 10s</div>
                  </div>
                  <div className="grid grid-cols-2 items-center gap-4">
                    <div className="font-medium">0-9</div>
                    <div>Jump to 0-90% of video</div>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
