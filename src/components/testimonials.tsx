...
//             <h2
//               className={`${workSans.className} text-3xl md:text-4xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-400 to-purple-700`}
//             >
//               What Our Clients Say
//             </h2>
