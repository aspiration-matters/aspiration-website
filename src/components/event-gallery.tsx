...
//     <section
//       id="gallery"
//       className="relative min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#e0c3fc]/80 via-[#8ec5fc]/70 to-[#ffffff]/80 backdrop-blur-2xl backdrop-saturate-200 backdrop-blur-sm py-16 px-0 overflow-hidden"
//     >
...
export function EventGallery() {
  ...
  return (
    <section
      id="gallery"
      className="relative min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#e0c3fc]/80 via-[#8ec5fc]/70 to-[#ffffff]/80 backdrop-blur-2xl backdrop-saturate-200 backdrop-blur-sm py-8 sm:py-12 md:py-16 px-0 overflow-hidden"
    >
      {/* Header section - position unchanged */}
      <div className="w-full max-w-7xl mx-auto mb-2 sm:mb-3 md:mb-4 lg:mb-5 xl:mb-6 text-center px-4 relative pt-6 sm:pt-10 md:pt-12">
        <div className="w-full flex justify-center mb-2 sm:mb-3 md:mb-4">
          <div className="relative inline-block text-center">
            <h2
              className={`${workSans.className} text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-400 to-purple-700 flex items-center gap-2 sm:gap-3 md:gap-5 drop-shadow-xl`}
            >
              <Camera className="w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7 text-indigo-400 animate-spin-slow" />
              Event Gallery
            </h2>
            <div className="absolute -bottom-2 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-purple-400 to-transparent" />
          </div>
      ...
      {images.length === 0 ? (
        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-2 sm:gap-3 md:gap-4 lg:gap-6 xl:gap-8 max-h-[70vh] sm:max-h-[75vh] md:max-h-[80vh] -mt-1 sm:-mt-2 md:-mt-3 lg:-mt-4 xl:-mt-5">
          {/* First row - right to left */}
          <div className="w-full overflow-hidden">
            <div className="flex animate-scroll-rtl">
              {firstRow.map((image, index) => (
          ...
          {/* Gradient overlays for fade effect */}
          <div className="pointer-events-none absolute inset-y-0 left-0 w-[10%] sm:w-[12%] md:w-[15%] bg-gradient-to-r from-transparent via-white/40 to-transparent z-10"></div>
          <div className="pointer-events-none absolute inset-y-0 right-0 w-[10%] sm:w-[12%] md:w-[15%] bg-gradient-to-l from-transparent via-white/40 to-transparent z-10"></div>
        </div>
      )}
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute -top-6 sm:-top-7 right-2 sm:right-4 text-black hover:text-purple-300 transition-colors z-10"
              aria-label="Close"
            >
            ...
            <div className="relative rounded-xl overflow-hidden p-0.5 sm:p-1">
              <div className="relative rounded-lg overflow-hidden">
                ...
                <BorderBeam duration={2} size={800} />
            ...
            <div className="mt-2 sm:mt-4 text-center px-2">
              <p className="text-black/90 text-xs sm:text-sm truncate">{selectedImage.alt}</p>
              <p className="text-black/70 text-xs mt-0.5 sm:mt-1">
                Image {selectedIndex + 1} of {images.length}
              </p>
            </div>
          </div>
