...
//     variant="ghost"
//     onClick={onClick}
//     className={`absolute top-1/2 -translate-y-1/2 z-30 h-12 w-12 rounded-full bg-white/80 hover:bg-white/90 backdrop-blur-sm text-gray-800 border border-gray-200 shadow-md ${className}`}
//   >
//     {children}
//   </Button>
// );
...
//                 <CarouselItem key={blog.id} className="pl-2 md:pl-4 md:basis-1/3 h-full">
//                   <BlogCard blog={blog} />
//                 </CarouselItem>
//               ))}
//             </CarouselContent>
//             <CarouselNavButton className="left-4">
//               <ChevronLeft className="h-6 w-6" />
//             </CarouselNavButton>
//             <CarouselNavButton className="right-4">
