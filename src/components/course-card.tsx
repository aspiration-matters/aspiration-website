...
//purple buttons  and not smae size cards
...
//       onMouseLeave={() => setIsHovered(false)}
//     >
//       <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.02] bg-white border-0">
...
//             {calculateDiscount() > 0 && (
//               <Badge className="absolute top-3 right-3 bg-red-500 text-white font-medium px-2 py-0.5 rounded-full shadow-lg">
...
//             <h3 className="text-lg font-semibold leading-tight bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent line-clamp-2">
//               {course.title}
//             </h3>
...
//               size="sm"
//               variant="outline"
//               className="border-purple-500 text-purple-600 hover:bg-purple-50 shadow-sm"
//               asChild
//             >
//               <Link href={`/course/${course.id}`}>
//                 <Play className="h-4 w-4 mr-2" />
...
//           ref={hoverCardRef}
//           className={cn(
//             "fixed z-50 bg-white rounded-xl shadow-2xl border-0 p-6 w-[340px]",
//             "transition-all duration-200 opacity-0 group-hover:opacity-100 backdrop-blur-sm bg-white/95"
//           )}
//           style={{
//             top: `${hoverPosition.top}px`,
//             left: `${hoverPosition.left}px`,
...
//         >
//           {course.videoPreview && (
//             <div className="relative mb-4 aspect-video rounded-lg overflow-hidden shadow-inner">
//               <video 
//                 src={course.videoPreview} 
//                 className="w-full h-full object-cover" 
//                 autoPlay 
...
//             </div>
//           )}
//           <h3 className="font-semibold text-xl mb-3 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
//             {course.title}
//           </h3>
//           <p className="text-sm text-muted-foreground mb-5 line-clamp-4">{course.description}</p>
