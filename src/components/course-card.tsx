...
//   const renderAddToCartButton = (variant = "main") => {
//     const content = isInCart(course.id) ? (
//       <>
//         <Check className="h-4 w-4 mr-2" />
//         Added
//       </>
...
//     const className =
//       "opacity-100 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white"
...
///not working asexpetced debug mode
