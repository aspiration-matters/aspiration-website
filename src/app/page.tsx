    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-100/80 to-white">
      ...
      <header
        className={cn(
          ...
          isScrolled
            ? "bg-gradient-to-r from-purple-200/60 via-blue-200/60 to-white/60 backdrop-blur-md shadow-lg"
            : "bg-gradient-to-r from-purple-200/40 via-blue-200/40 to-white/40 backdrop-blur-sm",
        )}
      >
        <div className="container mx-auto px-4">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden md:block">
              <NavigationMenu className="bg-white/30 backdrop-blur-md rounded-full border border-white/50 shadow-lg p-1.5">
            ...
            <Button
              variant="outline"
              size="icon"
              className="md:hidden bg-white/70 text-purple-700 hover:bg-white hover:text-purple-800 rounded-full border-purple-200 shadow-md"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-gradient-to-b from-purple-200/90 via-blue-200/90 to-white/90 backdrop-blur-md shadow-xl border-t border-white/50 rounded-b-2xl">
      ...
      >
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">
            Welcome to Our Website
          </h1>
          <p className="text-xl md:text-2xl text-purple-700 mb-8 max-w-3xl mx-auto">
            Discover our amazing services and learn more about what we offer
          </p>
          <Button
            className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-8 py-6 rounded-full text-lg shadow-lg hover:shadow-xl transition-all duration-300"
