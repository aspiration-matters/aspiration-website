...
//   const [mobileMenuOpen, setMobileMenuOpen] = useState(false)
//   const [activeSection, setActiveSection] = useState("home")
//   const { deviceSize, isPhone, isTablet, isLaptop, isDesktop } = useResponsive()
...
//       >
//         <div className="container mx-auto px-4 sm:px-6 lg:px-10 text-end">
//           {/* SpinningText components remain the same */}
...
//                 {/* Mobile Content */}
//                 <div className="sm:hidden text-center px-4 mt-[-200px]">
//                   <h2 className="text-2xl font-semibold mb-4">
//                     Power up{" "}
//                     <span className="bg-gradient-to-r from-purple-600 via-purple-400 to-purple-700 text-transparent bg-clip-text">
//                       !!
...
//           {/* Globe Demo - Enhanced responsive sizing */}
//           <div className="mt-8 sm:mt-12 w-full max-w-[250px] xs:max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] xl:max-w-[700px] 2  xs:max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] xl:max-w-[700px] 2xl:max-w-[800px] 3xl:max-w-[900px] 4xl:max-w-[1000px] mx-auto globe-container">
//             <GlobeDemo />
//           </div>
//         </div>
//       </section>
