...
// import { ChevronLeft, Users, Target, Award, Clock, ArrowRight } from "lucide-react"
...
//                         <h2
//                             className={`${workSans.className} text-2xl sm:text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-400 to-purple-700`}
//                         >
//                             Our Offline Courses
//                         </h2>
//                         <p className="text-gray-600/80 max-w-2xl mx-auto text-sm sm:text-base font-medium mt-3 sm:mt-4 px-4">
...
//                         Showing all <span className="font-semibold text-purple-700">{courses.length}</span> professional training
//                         courses
//                     </p>
//                 </div>
//             </div>
