...
export function GlobeDemo() {
  return (
    <div className="relative w-full flex justify-center md:justify-end">
      ...
      <Globe className="w-[330px] h-[330px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[700px] lg:h-[600px] absolute md:right-[-50px] md:top-[-50px] lg:right-[-350px] lg:top-[-200px]  md:w-[500px] md:h-[500px]  xl:right-[-1150px] xl:top-[-470px] " />
